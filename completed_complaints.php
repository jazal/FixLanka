...
<head>
    ...
    <link rel="stylesheet" href="css/completed_complaints.css">
</head>
<body>
    <div class="container">
            ...
            row.addEventListener('click', function() {
                ...
                if (complaint.media_path) {
                    ...
                    if (['jpg', 'jpeg', 'png', 'gif'].includes(mediaExtension)) {
                        mediaHtml = '<p><strong>Complaint Media:</strong></p><img src="' + complaint.media_path + '" alt="Complaint Image" style="max-width: 100%; height: auto;">';
                    } else if (['mp4', 'webm', 'ogg'].includes(mediaExtension)) {
                         mediaHtml = '<p><strong>Complaint Media:</strong></p><video controls style="max-width: 100%; height: auto;"><source src="' + complaint.media_path + '" type="video/' + mediaExtension + '">Your browser does not support the video tag.</video>';
                    } else {
                         mediaHtml = '<p><strong>Complaint Media:</strong> <a href="' + complaint.media_path + '" target="_blank">Download Media</a></p>';
                    }
                }
